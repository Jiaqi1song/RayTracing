...
__global__ void create_world1(hittable **d_list, hittable_list **d_world, hittable **d_light_list, hittable_list **d_lights, camera **cam, int image_width,
                             int image_height, curandState *devStates, int samples_per_pixel, int max_depth, bool use_bvh)
{
    ...
    *d_world = new hittable_list(d_list, i);
    ...
    // Light Sources
    d_light_list[0] = new sphere(point3(0,-1000,0), 1, new material());
    d_light_list[1] = new sphere(point3(0,-1000,0), 2, new material());
...
__global__ void create_world2(hittable **d_list, hittable_list **d_world, hittable **d_light_list, hittable_list **d_lights, camera **cam, int image_width,
                             int image_height, curandState *devStates, int samples_per_pixel, int max_depth, bool use_bvh)
{
    // Cornell box sides
    int i = 0;
    ...
    *d_world = new hittable_list(d_list, i);
    ...
    // Light Sources
    d_light_list[0] = new quad(point3(343,554,332), vec3(-130,0,0), vec3(0,0,-105), new material());
    d_light_list[1] = new sphere(point3(190, 90, 190), 90, new material());
    *d_lights = new hittable_list(d_light_list, 2);
...
__global__ void create_world3(hittable **d_list, hittable_list **d_world, hittable **d_light_list, hittable_list **d_lights, camera **cam, int image_width,
                             int image_height, curandState *devStates, int samples_per_pixel, int max_depth, bool use_bvh)
{
    curandState *local_rand_state = &devStates[0];
...
__global__ void free_world(hittable **d_list, hittable_list **d_world, hittable **d_light_list, hittable_list **d_lights, camera **d_camera, int max_depth)
{
...
int main(int argc, char* argv[])
{
    ...
    switch (scene) {
        case 1: create_world1<<<1, 1>>>(d_list, d_world, d_light_list, d_lights, cam, image_width, image_height, d_rand_state, samples_per_pixel, max_depth, use_bvh); break;
        case 2: create_world2<<<1, 1>>>(d_list, d_world, d_light_list, d_lights, cam, image_width, image_height, d_rand_state, samples_per_pixel, max_depth, use_bvh); break;
        case 3: create_world3<<<1, 1>>>(d_list, d_world, d_light_list, d_lights, cam, image_width, image_height, d_rand_state, samples_per_pixel, max_depth, use_bvh); break;
    }
    ...
    checkCudaErrors(cudaDeviceSynchronize());
    free_world<<<1, 1>>>(d_list, d_world, d_light_list, d_lights, cam, max_depth);
    checkCudaErrors(cudaGetLastError());
