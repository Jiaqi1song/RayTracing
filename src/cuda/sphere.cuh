...
class sphere : public hittable {
  public:
    // Stationary Sphere
    __device__ sphere(const point3& static_center, float radius, shared_ptr<material> mat)
    ...
    // Moving Sphere
    __device__ sphere(const point3& center1, const point3& center2, float radius,
