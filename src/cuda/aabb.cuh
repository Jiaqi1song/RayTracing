...
__device__ const aabb aabb::empty    = aabb(interval::empty,    interval::empty,    interval::empty);
__device__ const aabb aabb::universe = aabb(interval::universe, interval::universe, interval::universe);
