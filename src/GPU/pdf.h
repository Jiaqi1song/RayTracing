...
class dynamic_pdf : public pdf{
  public:
    __device__ dynamic_pdf() {}

    __device__ dynamic_pdf(const vec3& w) : uvw(w) {}
    ...
    __device__ void set_type(pdf_type new_type) {type = new_type;}
    pdf_type type = UNKNOW;
